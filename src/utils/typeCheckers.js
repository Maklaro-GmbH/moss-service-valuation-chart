...
const typeCheckers = {
  ...
  checkRequiredParamsArePassed: (payloadToCheck, requiredParamNames, payloadPath = 'payload') => {
    if (!typeCheckers.isObject(payloadToCheck)) throw messages.invalidType(payloadPath, 'object')
